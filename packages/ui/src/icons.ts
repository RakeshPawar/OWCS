/**
 * SVG icons for the OWCS Viewer component
 */

import { html } from 'lit';

/**
 * Web Component logo icon
 */
export const webComponentIcon = html`
...
/**
 * Chevron down toggle icon
 */
export const toggleIcon = html`
...
/**
 * Chevron down icon for component toggle
 */
export const componentToggleIcon = html`
...
/**
 * Chevron down icon for metadata toggle
 */
export const metadataToggleIcon = html`
...
/**
 * Chevron down icon for section toggle
 */
export const sectionToggleIcon = html`
